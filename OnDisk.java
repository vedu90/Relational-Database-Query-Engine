...
public class OnDisk {
		...
		//		System.out.println("debugging1");
				...
				//	System.out.println("debugging2");
					...
					if(referenceMap.size()==0){
						...
						File f1 = new File("data/CUSTOMER.csv");
						Long len = f1.length();
						tableLength obj1 = new tableLength(len,"CUSTOMER");
						tableSizes.add(obj1);
						...
						f1 = new File("data/NATION.csv");
						len = f1.length();
						tableLength obj2 = new tableLength(len,"NATION");
						tableSizes.add(obj2);
						...
						f1 = new File("data/SUPPLIER.csv");
						len = f1.length();
						tableLength obj3 = new tableLength(len,"SUPPLIER");
						tableSizes.add(obj3);
						...
						f1 = new File("data/REGION.csv");
						len = f1.length();
						tableLength obj4 = new tableLength(len,"REGION");
						tableSizes.add(obj4);
				...
				//		referenceList4.add("PARTKEY");
						...
						f1 = new File("data/LINEITEM.csv");
						len = f1.length();
						tableLength obj5 = new tableLength(len,"LINEITEM");
						tableSizes.add(obj5);
						...
						f1 = new File("data/ORDERS.csv");
						len = f1.length();
						tableLength obj6 = new tableLength(len,"ORDERS");
						tableSizes.add(obj6);
						...
						f1 = new File("data/PARTSUPP.csv");
						len = f1.length();
						tableLength obj7 = new tableLength(len,"PARTSUPP");
						tableSizes.add(obj7);
						...
						f1 = new File("data/PART.csv");
						len = f1.length();
						tableLength obj8 = new tableLength(len,"PART");
						tableSizes.add(obj8);
						
						Collections.sort(tableSizes,new sortTables());
					...
					if(phase1){
						...
						colDataTypes.add(Datatypes.STRING);
						colDataTypes.add(Datatypes.STRING);
						List<Boolean> colSortType = new ArrayList<Boolean>();
						colSortType.add(true);
						colSortType.add(true);
						String filePath = dataPath+"sortedTables/"+"LINEITEM_8_9";
						ExternalSort.DoExternalSorting(dataPath+"LINEITEM.csv",colIndexes,colDataTypes
	...
	//	System.out.println("debugging2");
		...
		try {
			if (Main.groupByFlag) {
			if(Main.tableName.equals("LINEITEM")){
				newTablePath=dataPath+"sortedTables/LINEITEM_8_9";
				lineItemFlag = true;
			}
			else{
				ArrayList<Integer> colIndexes = new ArrayList<Integer>();
